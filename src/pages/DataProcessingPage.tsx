        ...
        <LegalContent>
          <LegalSection>
            ...
            <LegalParagraph>
              ...
              and {process.env.REACT_APP_COMPANY_NAME} ("Data Processor") for the provision of retail discount membership and shopping services.
            </LegalParagraph>
            <LegalParagraph>
          ...
          <LegalSection>
            ...
            <LegalList>
              <LegalListItem>Providing retail discount and membership services as described in the service agreement</LegalListItem>
              <LegalListItem>Analyzing shopping preferences to recommend suitable products</LegalListItem>
              <LegalListItem>Communicating with members regarding purchases and benefits</LegalListItem>
              <LegalListItem>Processing payments and managing purchase transactions</LegalListItem>
              <LegalListItem>Providing customer support and shopping assistance</LegalListItem>
              <LegalListItem>Generating purchase reports and analytics for the Data Controller</LegalListItem>
            ...
            <LegalParagraph style={{ marginTop: '1rem' }}>
              ...
              payment information, purchase history, shipping addresses, shopping preferences, and communication records.
            </LegalParagraph>
            <LegalParagraph>
              The categories of Data Subjects include: members, shoppers, potential members, and authorized representatives of 
              the Data Controller.
            </LegalParagraph>
          </LegalSection>
