      ...
      <LegalPageContainer>
        ...
        <LegalContent>
          <LegalSection>
            ...
            <LegalParagraph>
              Our digital products include membership portal access, shopping discount platform, mobile applications, 
          ...
          <LegalSection>
            ...
            <LegalList>
              <LegalListItem>
                <strong>Membership Portal:</strong> Cloud-based shopping discount platform accessible via web browser
              </LegalListItem>
              <LegalListItem>
                <strong>API Access:</strong> RESTful API for partners and affiliates to integrate retail discount services
              </LegalListItem>
              <LegalListItem>
                <strong>Shopping Dashboard:</strong> Tools to view orders, track rewards, and access purchase reports
              </LegalListItem>
              <LegalListItem>
                <strong>Mobile Applications:</strong> iOS and Android apps for shopping discounts and managing your membership
              </LegalListItem>
              <LegalListItem>
                <strong>Shopping Guides:</strong> Digital shopping resources, brand guides, and member benefits information
              </LegalListItem>
              <LegalListItem>
                <strong>Documentation & Support:</strong> Help articles, shopping tutorials, FAQs, and savings tips
              </LegalListItem>
            </LegalList>
          </LegalSection>
          ...
          <LegalSection>
            ...
            <LegalList>
              ...
              <LegalListItem>
                <strong>Email Delivery:</strong> Order confirmations, membership details, and discount vouchers are sent to your email
              </LegalListItem>
              <LegalListItem>
                <strong>Account Required:</strong> An active membership account is required for access to exclusive retail deals
              </LegalListItem>
            </LegalList>
          </LegalSection>
