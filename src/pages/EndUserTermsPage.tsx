      ...
      <LegalPageContainer>
        ...
        <LegalContent>
          ...
          <LegalSection>
            ...
            <LegalParagraph>
              {process.env.REACT_APP_COMPANY_NAME} provides exclusive retail discount membership benefits and shopping services. 
              Our services include:
            </LegalParagraph>
            <LegalList>
              <LegalListItem>
                <strong>Retail Discount Services:</strong> Access to exclusive rates at major retailers, brands, online stores, and shopping partners
              </LegalListItem>
              <LegalListItem>
                <strong>Membership Benefits:</strong> Email and notifications about exclusive retail deals and member rewards
              </LegalListItem>
              <LegalListItem>
                <strong>Order Management:</strong> Secure portal for viewing, tracking, and managing purchases
              </LegalListItem>
              <LegalListItem>
                <strong>Shopping Support:</strong> 24/7 assistance with orders, shopping issues, and concierge services
              </LegalListItem>
              <LegalListItem>
                <strong>Secure Payment Processing:</strong> PCI-compliant payment processing for all retail transactions
              </LegalListItem>
            </LegalList>
            <LegalParagraph style={{ marginTop: '1rem' }}>
              We act as your retail discount service provider and process transactions through our partner network of retailers, brands, 
              and shopping providers worldwide.
            </LegalParagraph>
          </LegalSection>
          ...
          <LegalSection>
            ...
            <LegalList>
              <LegalListItem>
                <strong>Authorization:</strong> You authorize us to charge your payment method for purchases, membership fees, 
                and any applicable taxes or fees
              </LegalListItem>
              <LegalListItem>
                <strong>Accuracy:</strong> You warrant that all payment and customer information provided is accurate and up-to-date
              </LegalListItem>
              <LegalListItem>
                <strong>Ownership:</strong> You confirm that you are authorized to use the payment method and that you have 
                sufficient funds or credit available for the purchase
              </LegalListItem>
              <LegalListItem>
                <strong>Order Confirmation:</strong> By completing a purchase, you authorize the charge and agree to the 
                return policies of the specific retailer
              </LegalListItem>
              <LegalListItem>
          ...
          <LegalSection>
            ...
            <LegalParagraph>
              Regarding refunds and order disputes:
            </LegalParagraph>
            <LegalList>
              <LegalListItem>
                <strong>Retailer Responsibility:</strong> Return and refund requests should be submitted through our platform 
                according to the specific retailer's return policy
              </LegalListItem>
              <LegalListItem>
                <strong>Return Policy:</strong> Each purchase is subject to the return policy of the specific retailer 
                or brand
              </LegalListItem>
              <LegalListItem>
                <strong>Processing Assistance:</strong> We will assist in facilitating refunds for purchases made through our platform
              </LegalListItem>
              <LegalListItem>
              ...
              <LegalListItem>
                <strong>Investigation:</strong> We will investigate disputed charges and work with you and the retailer to resolve
                the issue
              </LegalListItem>
            </LegalList>
          </LegalSection>
          ...
          <LegalSection>
            ...
            <LegalList>
              ...
              <LegalListItem>
                We share data with retail partners and service providers only as necessary to complete purchases and provide services
              </LegalListItem>
              <LegalListItem>
          ...
          <LegalSection>
            ...
            <LegalList>
              ...
              <LegalListItem>
                We are not liable for retailer actions, product quality, or order fulfillment issues
              </LegalListItem>
              <LegalListItem>
          ...
          <LegalSection>
            ...
            <LegalList>
              ...
              <LegalListItem>At the request of a retail partner or payment processor</LegalListItem>
