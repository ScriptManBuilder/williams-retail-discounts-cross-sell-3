        ...
        <LegalContent>
          <LegalSection>
            ...
            <LegalParagraph>
              ...
              our retail discount membership services and visit our website.
            </LegalParagraph>
            <LegalParagraph>
          ...
          <LegalSection>
            ...
            <LegalList>
              ...
              <LegalListItem><strong>Financial Information:</strong> Payment card details, bank account information, purchase transaction history</LegalListItem>
            </LegalList>

            <LegalParagraph style={{ fontWeight: 600, marginTop: '1.5rem' }}>
              Member and Shopping Data
            </LegalParagraph>
            <LegalList>
              <LegalListItem><strong>Purchase Data:</strong> Order history, product details, transaction amounts, order status</LegalListItem>
              <LegalListItem><strong>Shopper Information:</strong> Names, shipping addresses, shopping preferences, special requirements</LegalListItem>
              <LegalListItem><strong>Communication Records:</strong> Email correspondence, support tickets, order confirmations</LegalListItem>
            </LegalList>
          ...
          <LegalSection>
            ...
            <LegalList>
              <LegalListItem><strong>Service Delivery:</strong> Process purchases, send order confirmations, manage transactions</LegalListItem>
              ...
              <LegalListItem><strong>Communication:</strong> Send order updates, shipping notifications, exclusive offers, membership benefits</LegalListItem>
              <LegalListItem><strong>Analytics:</strong> Analyze shopping patterns, improve service performance, develop new retail features</LegalListItem>
              <LegalListItem><strong>Compliance:</strong> Comply with legal obligations, prevent fraud, enforce our terms</LegalListItem>
              <LegalListItem><strong>Marketing:</strong> Send promotional retail deals, personalize content, conduct market research</LegalListItem>
            </LegalList>
          </LegalSection>
          ...
          <LegalSection>
            ...
            <LegalList>
              <LegalListItem>
                <strong>Service Providers:</strong> Retailers, e-commerce platforms, shipping companies, payment processors, email service providers, 
                analytics platforms, cloud hosting providers who assist in delivering our retail discount services
              </LegalListItem>
              <LegalListItem>
                <strong>Business Partners:</strong> Retail partners, cashback providers, affiliate networks, and integration partners 
