        ...
        <LegalContent>
          <LegalSection>
            ...
            <LegalParagraph>
              ...
              retail discounts membership program.
            </LegalParagraph>
            <LegalParagraph>
          ...
          <LegalSection>
            ...
            <LegalParagraph>
              {process.env.REACT_APP_COMPANY_NAME} provides exclusive retail discounts and membership benefits designed to help 
              members save on purchases and access premium shopping services. Our services include:
            </LegalParagraph>
            <LegalList>
              <LegalListItem>Exclusive discounts on major retailers, brands, online stores, and shopping partners</LegalListItem>
              <LegalListItem>24/7 shopping concierge and purchase assistance</LegalListItem>
              <LegalListItem>Cashback rewards program and member benefits tracking</LegalListItem>
              <LegalListItem>Access to member-only retail deals and exclusive offers</LegalListItem>
              <LegalListItem>Shopping support, price match, and customer service</LegalListItem>
            </LegalList>
          </LegalSection>
          ...
          <LegalSection>
            ...
            <LegalParagraph>
              Our retail discounts membership is provided on a subscription basis, as detailed in your membership agreement. 
            ...
            <LegalList>
              ...
              <LegalListItem>Purchases are charged separately by retailers at the time of transaction</LegalListItem>
